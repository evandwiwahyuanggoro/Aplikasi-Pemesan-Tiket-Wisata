        ...
        <div class="col-xs-12">
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="" method="post">
                    ...
                    <div class="form-group">
                        <label for="no_hp" class="col-sm-3 control-label">Nomer HP</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group">
                        <label for="nama_wisata" class="col-sm-3 control-label">Nama Wisata</label>
                        <div class="col-sm-2 col-xs-9">
                            <select name="nama_wisata" id="nama_wisata" class="form-control">
...
if ($_POST) {
    ...
    //buat sql
    $sql = "INSERT INTO pemesanan VALUES ('','$nama','$no_identitas','$no_hp','$nama_wisata','$tanggal_kunjungan',
    '$pengunjung_dewasa','$pengunjung_anak','$tiket','$total_harga')";
